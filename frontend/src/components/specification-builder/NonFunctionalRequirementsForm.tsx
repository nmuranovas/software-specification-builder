...
const NonFunctionalRequirementsForm = () => {
    ...
    return (
        <React.Fragment>
            ...
            <Button onClick={addNewRequirement} disabled={maximumNFRCount === functionalRequirements.length} variant="contained" color="primary">
                Add requirement
            </Button>
        </React.Fragment>
    )
...
export default NonFunctionalRequirementsForm
